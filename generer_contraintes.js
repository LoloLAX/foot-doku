...
// ── Traduction des noms de pays (doit rester cohérente avec generer_browser_db.js) ──
const PAYS_FR = {
...
// Déclaration PAYS_FR à injecter dans les templates generateur.js / moteur.js
const PAYS_FR_DECL = 'const PAYS_FR = ' + JSON.stringify(PAYS_FR) + ';';
